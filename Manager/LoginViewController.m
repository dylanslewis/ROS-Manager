...
- (IBAction)didTouchForgotPasswordButton:(id)sender {
    // Show an alert allowing the user to input their email address.
    [self displayEmailInputWithTitle:@"Forgot your password?" withMessage:@"Please enter your email address to reset your password" withPlaceholder:@"email address"];
}
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    if ([alertView.title isEqualToString:@"Forgot password"]) {
        ...
        NSString *email = [_alertView textFieldAtIndex:0].text;
...
- (void)loginUserWithUsername:(NSString *)username withPassword:(NSString *)password {
    ...
    if (!localErrorsPresent) {
        ...
        [_forgotPasswordButton setUserInteractionEnabled:NO];
        ...
        [PFUser logInWithUsernameInBackground:username password:password
                                        block:^(PFUser *user, NSError *error) {
                                            ...
                                            if (user) {
                                                ...
                                                [_forgotPasswordButton setUserInteractionEnabled:YES];
